...
public class LocketteProAPI {
    ...
    public static boolean isUpDownAlsoLockableBlock(Block block){
        if (Config.isLockable(block.getType())){
            return switch (block.getType()) {
                case OAK_DOOR, SPRUCE_DOOR, BIRCH_DOOR, JUNGLE_DOOR, ACACIA_DOOR, DARK_OAK_DOOR, CRIMSON_DOOR, WARPED_DOOR, IRON_DOOR ->
                        true;
                default -> false;
            };
        }
    ...
    public static boolean isSingleDoorBlock(@Nullable Block block){
        ...
        return switch (block.getType()) {
            case OAK_FENCE_GATE, SPRUCE_FENCE_GATE, BIRCH_FENCE_GATE, CRIMSON_FENCE_GATE, WARPED_FENCE_GATE, ACACIA_FENCE_GATE, JUNGLE_FENCE_GATE, ACACIA_TRAPDOOR, DARK_OAK_TRAPDOOR, CRIMSON_TRAPDOOR, WARPED_TRAPDOOR, BIRCH_TRAPDOOR, OAK_TRAPDOOR, SPRUCE_TRAPDOOR, IRON_TRAPDOOR ->
                    true;
            default -> false;
        };
    }
